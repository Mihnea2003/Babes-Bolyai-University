...
public:
    ...
    virtual Tutorial findTutorialUserRepo(std::string title);
    ...
    virtual void addTutorialUserRepo(Tutorial tutorial);
    ...
    virtual void deleteTutorialUserRepo(std::string title);

    /// <summary>
    /// This function gets the tutorials list from the repository.
    /// </summary>
    /// <returns>the tutorials list</returns>
    virtual std::vector<Tutorial> getWatchList() const;
