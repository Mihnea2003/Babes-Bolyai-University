...
void test_last_index_of() {
	std::cout << "Test for the new function\n";
	SortedIndexedList list = SortedIndexedList(asc);
	list.add(1);
	list.add(3);
	list.add(3);
	...
	assert(list.last_index_of(0) == -1);
	assert(list.last_index_of(1) == 0);
	assert(list.last_index_of(2) == -1);
	assert(list.last_index_of(3) == 2);
	assert(list.last_index_of(4) == -1);
	assert(list.last_index_of(5) == 5);
}
