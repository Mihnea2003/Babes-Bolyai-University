...
void testExtraOperation(){
    cout<<"Test Remove Extra Operation"<<endl;
    SortedBag bag(relation2);
    ...
    iterator.first();
    int removedElement = iterator.remove();
    assert(removedElement == 1);
    iterator.first();
    int removedElement1 = iterator.remove();
    assert(removedElement1 == 2);
    cout<<"Test end";
}
