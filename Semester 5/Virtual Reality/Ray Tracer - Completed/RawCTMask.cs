...
public class RawCtMask: Geometry
{
    ...
    public override Intersection GetIntersection(Line line, double minDist, double maxDist)
    {
        ...
        return new Intersection(true, true, this, new Line(line.CoordinateToPosition(tIntersect), line.Dx), tIntersect, normal, Material.FromColor(globalColor), globalColor);
    }
