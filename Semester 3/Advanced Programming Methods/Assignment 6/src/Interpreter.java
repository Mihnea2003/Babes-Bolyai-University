...
public class Interpreter {
    public static void main(String[] args){
        ...
        MyIFileTable<String, BufferedReader> fileTable1 = new MyFileTable<>();
        MyIHeap<Integer,Value> heap1 = new MyHeap<Integer,Value>();

        PrgState prgState1 = new PrgState(stk1, symtbl1, out1,fileTable1, ex1,heap1);
        List<PrgState> myPrgList1 = List.of(prgState1);
        IRepository repo1 = new Repository(myPrgList1, "log1.txt");
                ...
                new CompStmt(new VarDeclStmt("v", new IntType()),
                        new CompStmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
                                new CompStmt(new IfStmt(new VarExp("a"),new AssignStmt("v",new ValueExp(new
                                        ...
                                        VarExp("v"))))));
        try{ex3.typeCheck(new MyDictionary<String, Type>());
        ...
        try{example4.typeCheck(new MyDictionary<String, Type>());
        ...
        PrgState prg4 = new PrgState(stk4,symtbl4,out4,fileTable4,example4,heap4);
        ...
        try{ex5.typeCheck(new MyDictionary<String, Type>());
        ...
        try{ex6.typeCheck(new MyDictionary<String, Type>());
        ...
        try{ex7.typeCheck(new MyDictionary<String, Type>());
        ...
        try{ex8.typeCheck(new MyDictionary<String, Type>());
        ...
        IStmt ex9 = new CompStmt(new VarDeclStmt("v",new IntType()),
                new CompStmt(new VarDeclStmt("a",new RefType(new IntType())),
                        new CompStmt(new AssignStmt("v",new ValueExp(new IntValue(10))),
                                new CompStmt(new NewStatement("a",new ValueExp(new IntValue(30))),
        ...
        menu.addCommand(new RunExample("9", ex9.toString(), ctr9));
            ...
            System.out.println("EX 9 TYPE CHECK ERROR: " + e.getMessage());
        }
        menu.show();
